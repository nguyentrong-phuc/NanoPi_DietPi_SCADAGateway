#!/bin/bash
# ==============================================================================
# WukongEdge SCADA Gateway - Auto Installation Script for DietPi/Debian
# ==============================================================================

echo "========================================================"
echo "  Starting Installation: WukongEdge SCADA Gateway UI"
echo "========================================================"
...
[Unit]
Description=WukongEdge SCADA Gateway Web UI
