        ...
        <div>
          <div style={{ display: 'flex', borderBottom: '2px solid #eee', marginBottom: '20px' }}>
            <div 
              ...
              style={{ padding: '10px 20px', cursor: 'pointer', color: activeTab === 'Ping' ? '#e29724' : '#666', borderBottom: activeTab === 'Ping' ? '2px solid #e29724' : 'none', marginBottom: '-2px', fontWeight: activeTab === 'Ping' ? 600 : 'normal' }}
            >
              Ping
            </div>
            <div 
              onClick={() => setActiveTab('Traceroute')}
              style={{ padding: '10px 20px', cursor: 'pointer', color: activeTab === 'Traceroute' ? '#e29724' : '#666', borderBottom: activeTab === 'Traceroute' ? '2px solid #e29724' : 'none', marginBottom: '-2px', fontWeight: activeTab === 'Traceroute' ? 600 : 'normal' }}
            >
              Traceroute
            </div>
          </div>
          ...
          <div style={{ display: 'flex', gap: '10px', marginBottom: '30px' }}>
            ...
            <button style={{ backgroundColor: '#e29724', color: 'white', border: 'none', padding: '8px 30px', borderRadius: '2px', cursor: 'pointer', fontWeight: 600 }}>Send</button>
          </div>
        </div>
